...
SELECT Valor_Hora
FROM Categoria
WHERE Categoria = 'Estagiário'
--Nome e valor das Categorias que ganham menos de 35.00 em ordem crescente de valor
SELECT Valor_Hora, Categoria
FROM Categoria
WHERE Valor_Hora < 35 ORDER BY Valor_Hora ASC
--Placa, marca, modelo e ano de fabricação dos carros cadastrados que foram fabricados entre 2000 e 2010
--em ordem crescente de marca e modelo
